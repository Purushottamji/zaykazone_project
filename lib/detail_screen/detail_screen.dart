          ...
          Row(
            children: [
              Container(
                ...
                width: width*0.5,
                height: 50,
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(30),color: Colors.grey,border: BoxBorder.all(color: Colors.black,width: 2)),
                child: Row(
                  children: [
                    SizedBox(
                      width: 20,
                         ...
                         child: SizedBox(width: double.infinity,
                           ...
                           child: Padding(
                             ...
                             child: ElevatedButton(onPressed: () {
                                }, child: Text("ADD TO CART",style: TextStyle(color: Colors.white),),style: ElevatedButton.styleFrom(backgroundColor: Colors.orange,shape: RoundedRectangleBorder(borderRadius: BorderRadiusGeometry.circular(10))),),
                           ),
                         ),
                       ),
